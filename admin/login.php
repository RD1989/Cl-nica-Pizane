...
<head>
    ...
    <style>
        ...
        .login-card { background: white; padding: 40px; border-radius: 16px; box-shadow: 0 20px 40px rgba(227, 27, 35, 0.1); width: 100%; max-width: 400px; text-align: center; border-top: 5px solid #E31B23; }
        h1 { font-family: 'Cinzel', serif; color: #E31B23; font-size: 24px; margin-bottom: 30px; }
        ...
        button { width: 100%; padding: 14px; background: #E31B23; color: white; border: none; border-radius: 8px; font-weight: 600; cursor: pointer; transition: 0.3s; margin-top: 10px; }
        button:hover { background: #B3141A; }
